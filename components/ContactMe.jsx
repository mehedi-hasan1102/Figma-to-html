...
const ContactMe = () => {
  ...
  return (
    ...
    >
      <div className="rounded-xl p-6 backdrop-blur-sm hover:shadow-primary/10 transition-shadow duration-300">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          >
            <form ref={formRef} onSubmit={sendEmail} className="flex flex-col gap-6">
              ...
              {success === true && (
                <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-success mt-2">
                  Message sent successfully!
                </motion.p>
              )}

              {success === false && (
                <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-error mt-2">
